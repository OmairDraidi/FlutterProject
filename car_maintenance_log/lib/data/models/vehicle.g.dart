...
void _vehicleSerialize(
  ...
  writer.writeString(offsets[2], object.make);
  writer.writeLong(offsets[3], object.mileage);
...
Vehicle _vehicleDeserialize(
  ...
  object.id = id;
  object.make = reader.readString(offsets[2]);
  object.mileage = reader.readLong(offsets[3]);
...
extension VehicleQueryWhereSort on QueryBuilder<Vehicle, Vehicle, QWhere> {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension VehicleQueryWhere on QueryBuilder<Vehicle, Vehicle, QWhereClause> {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> makeEqualTo(String make) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> makeNotEqualTo(
      String make) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> createdAtEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> createdAtNotEqualTo(
      DateTime createdAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> createdAtGreaterThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> createdAtLessThan(
    DateTime createdAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterWhereClause> createdAtBetween(
...
extension VehicleQueryFilter
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameEqualTo(
    String value, {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterFilterCondition> displayNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'displayName',
        value: '',
...
extension VehicleQuerySortBy on QueryBuilder<Vehicle, Vehicle, QSortBy> {
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> sortByDisplayName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.asc);
    });
  }

  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> sortByDisplayNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension VehicleQuerySortThenBy
  ...
  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> thenByDisplayName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.asc);
    });
  }

  QueryBuilder<Vehicle, Vehicle, QAfterSortBy> thenByDisplayNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'displayName', Sort.desc);
    });
  }
...
extension VehicleQueryWhereDistinct
  ...
  QueryBuilder<Vehicle, Vehicle, QDistinct> distinctByDisplayName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension VehicleQueryProperty
  ...
  QueryBuilder<Vehicle, String, QQueryOperations> displayNameProperty() {
    return QueryBuilder.apply(this, (query) {
